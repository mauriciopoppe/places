...
<div id="mainContent">
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			<h1>Sucursales</h1>
			<p>Ingrese aqui para editar sucursales</p>
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			<h1>Atms</h1>
			<p>Ingrese aqui para editar atms (cajeros automaticos)</p>
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			<h1>Hospitales</h1>
			<p>Ingrese aqui para editar hospitales</p>
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			<h1>Hoteles</h1>
			<p>Ingrese aqui para editar hoteles</p>
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			<h1>Farmacias</h1>
			<p>Ingrese aqui para editar farmacias</p>
	...
	<div class="view view-first box_shadow">
		...
		<div class="mask">
			...
			<p>Ingrese aqui para editar administradores</p>
